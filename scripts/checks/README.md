...
Standalone checks retained from the 2026-08 pre-freeze adversarial review
(the rest of the review artifacts were removed before release).
...
- `05_h1a_replicate_collapse.py` — live check that replicate seeds reach the
  reducers (distinct replicates) and that the H1a Wilcoxon runs on honest n.

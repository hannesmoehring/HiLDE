...
from src_research.rederive import REDERIVED_DIRNAME, h1a, h2b, internal_external, verdicts


def main() -> None:
    print(f"Re-deriving corrected aggregates into outputs/experiments/<run>/{REDERIVED_DIRNAME}/")
